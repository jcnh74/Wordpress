			...
			if(sizeof($result1)>0)
			{
				...
				<li>
					<div class="list_box general" onclick="launchInfoWindow(<?php echo $i?>);">
                        ...
                        <div class="right">
                            <?php if($phone!=""){?><p><strong>Phone:</strong> <?php echo $phone; ?></p><?php }?>
                            <?php if($mobile!=""){?><p><strong>Mobile:</strong> <?php echo $mobile; ?></p><?php }?>
                            <?php if($fax!=""){?><p><strong>Fax:</strong> <?php echo $fax; ?></p><?php }?>
                        </div>
                        <div class="clear"></div>
                    </div>
			   </li>
