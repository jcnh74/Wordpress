	...
	public function __construct() {
		...
		$this->settings = array(
			...
			'send_invoices'      => array(
				...
				'default'     => 'off',
				'type'        => 'checkbox',
				'description' => __(  'Send Invoices to Xero automatically when order status is changed to completed', 'wc-xero' ),
			),
			'send_payments'      => array(
				'title'       => __( 'Auto Send Payments', 'wc-xero' ),
				'default'     => 'off',
				'type'        => 'checkbox',
				'description' => __(  'Send Payments to Xero automatically when order is set to completed. This may need to be turned off if you sync via a separate integration such as PayPal.', 'wc-xero' ),
			),
