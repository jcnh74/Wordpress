    ...
    class LR_Social_Share_Settings {
        ...
        private static function vertical_share_interface_position($page, $settings) {
            ...
            foreach ($interface_location as $location) {
                ...
                <label>
                    ...
                    <span class="lr-text"><?php _e(str_replace(' ', '-', $location) . ' of the content', 'LoginRadius'); ?></span>
                </label>
            <?php
            }
            echo '</div>';
        ...
        private static function horizontal_share_interface_position($page, $settings) {
            ...
            foreach ($interface_location as $location) {
                ...
                <label>
                    ...
                    <span class="lr-text"><?php _e($location . ' of the content', 'LoginRadius'); ?></span>
                </label>
            <?php
            }
            echo '</div>';
                ...
                <div class="lr_options_container">
                    ...
                    <div class="lr_enable_switch lr-row">
                        <label for="lr-enable-vertical" class="lr-toggle">
                            <input type="checkbox" class="lr-toggle" id="lr-enable-vertical" name="LoginRadius_share_settings[vertical_enable]" value="1" <?php echo ( isset($settings['vertical_enable']) && $settings['vertical_enable'] == '1') ? 'checked' : ''; ?> <?php _e('Yes', 'LoginRadius') ?> />
                            <span class="lr-toggle-name"><?php _e('Enable Vertical Widget', 'LoginRadius'); ?></span>
                        </label>
                    </div>

                    <div class="lr-option-disabled-vr"></div>
                    <div class="lr_vertical_interface lr-row cf">
                        <h3><?php _e('Select the sharing theme', 'LoginRadius'); ?></h3>
                        <div>
                    ...
                    <div id="lr_ve_theme_options" class="lr-row cf">
                        <h3><?php _e('Select the sharing networks', 'LoginRadius'); ?>
                            <span class="lr-tooltip" data-title="<?php _e('Selected sharing networks will be displayed in the widget', 'LoginRadius'); ?>">
                        ...
                        <div id="lr_ve_hz_theme_options" class="cf" style="display:block;">
                            ...
                            <p class="lr-footnote">*<?php _e('All other icons will be included in the pop-up', 'LoginRadius'); ?></p>
                        </div>
                    ...
                    <div class="lr-row cf" id="login_radius_vertical_rearrange_container">
                        <h3 class="lr-column2">
                            ...
                            <span class="lr-tooltip" data-title="<?php _e('Drag the icons around to set the order', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                    ...
                    <div class="lr-row">
                        <h3>
                            ...
                            <span class="lr-tooltip" data-title="<?php _e('Sharing widget will be displayed at the selected location(s)', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-vr-home">
                                <?php _e('Home Page', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('Home page of your blog', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </label>
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-vr-post">
                                <?php _e('Blog Posts','LoginRadius');?>
                                <span class="lr-tooltip" data-title="<?php _e('Each post of your blog', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </label>
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-vr-static">
                                <?php _e('Static Pages', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('Static pages of your blog (e.g &ndash; about, contact, etc.)', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </label>
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-vr-custom">
                                <?php _e('Custom Post Types', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('Custom Post Types', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </label>
                ...
                <div class="lr_options_container">
                    ...
                    <div class="lr_enable_switch lr-row">
                        <label for="lr-enable-horizontal" class="lr-toggle">
                            ...
                            <span class="lr-toggle-name"><?php _e('Enable Horizontal Widget', 'LoginRadius'); ?></span>
                        </label>
                    </div>
                    ...
                    <div class="lr-row cf">
                        <h3><?php _e('Choose the location(s) to display the widget', 'LoginRadius'); ?>
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-hr-excerpts">
                                <?php _e('Post Excerpts', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('Post excerpts page', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </label>
        ...
        private static function advance_settings($settings) {
            ...
            <div id="lr_options_tab-3" class="lr-tab-frame">
                <div class="lr_options_container">
                    <div class="lr-row">
                        <h3><?php _e('Short Code for Sharing widget', 'LoginRadius'); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Copy and paste the following shortcode into a page or post to display a horizontal sharing widget', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                        <div>
                            <textarea rows="1" onclick="this.select()" spellcheck="false" class="lr-shortcode" readonly="readonly">[Social9_Share]</textarea>
                        </div>
                        <span><?php _e('Additional shortcode examples can be found <a target="_blank" href="http://ish.re/RPQM" >Here</a>', 'LoginRadius'); ?></span>
                    </div><!-- lr-row -->
                    <div class="lr-row">
                        <h3><?php _e('Mobile Friendly', 'LoginRadius'); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Enable this option to show a mobile sharing interface to mobile users', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                        <div>
                            <label for="lr-enable-mobile-friendly" class="lr-toggle">
                                ...
                                <span class="lr-toggle-name"><?php _e('Enable Mobile Friendly', 'LoginRadius'); ?></span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="wrap lr-wrap cf">
                ...
                <div class="lr-sidebar">
                    <div class="lr-frame">
                        ...
                        <div>
                            <a target="_blank" href="http://ish.re/RPLD"><?php _e('Plugin Installation, Configuration and Troubleshooting', 'LoginRadius') ?></a>
                            <a target="_blank" href="http://ish.re/ROSR"><?php _e('Social9 Features', 'LoginRadius') ?></a>
