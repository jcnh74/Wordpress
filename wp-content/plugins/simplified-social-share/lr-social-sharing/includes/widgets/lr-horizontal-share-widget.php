...
class LR_Horizontal_Share_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            __( 'LoginRadius - Horizontal Sharing', 'LoginRadius' ), // Name
            array( 'description' => __( 'Share content with Facebook, Twitter, Yahoo, Google and many more', 'LoginRadius' ), ) // Args
        );
    }
