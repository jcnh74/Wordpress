    ...
    class LR_Social_Sharing {
        ...
        function create_loginradius_menu() {
            ...
            if ( ! class_exists( 'LR_Social_Login' ) ) {
                // Create Menu.		
                add_menu_page('LoginRadius', 'Social Sharing', 'manage_options', 'social9_share', array('LR_Social_Share_Admin', 'options_page'), LR_CORE_URL . 'assets/images/favicon.ico' );
            } else {
                // Add Social Sharing menu.
                add_submenu_page('LoginRadius', 'Social Sharing Settings', 'Social Sharing', 'manage_options', 'social9_share', array('LR_Social_Share_Admin', 'options_page'));
            }
        }
