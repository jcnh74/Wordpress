    ...
    class LR_Core {
        ...
        function loginradius_login_setting_links($links, $file) {
            ...
            if ($file == $thisPlugin) {
                ...
                $settingsLink .= '">' . __( 'Settings', 'LoginRadius' ) . '</a>';
        ...
        public function define_constants() {
            ...
            define('LR_PLUGIN_VERSION', '3.5.1');
            // Type of Plugin ADV, SL, SS, S9
            define('LR_PLUGIN_PKG', 'S9');
        ...
        public static function register_scripts_styles() {
            ...
            wp_register_style( 'lr-form-style', LR_CORE_URL . 'assets/css/lr-form-style.css', array(), LR_PLUGIN_VERSION );

            // LR Raas popup css used in LR Raas Popups and LiveFyre Modules
            wp_register_style( 'lr-raas-popup-style', LR_CORE_URL . 'assets/css/lr-raas-popup-style.css', array(), LR_PLUGIN_VERSION );
            ...
            wp_register_script( 'lr-social-sharing', '//sharecdn.social9.com/v1/social9.min.js', array(), LR_PLUGIN_VERSION, $lr_js_in_footer);
        ...
        public function reset_settings($option_name) {
            ...
            <div class="lr_options_container">	
                <div class="lr-row lr-reset-body">
                    <h5><?php _e('Reset all the '.$option_name.' options to the default recommended settings.', 'LoginRadius'); ?>
                        <span class="lr-tooltip" data-title="<?php _e('This option will reset all the settings to the default '.$option_name.' plugin settings', 'LoginRadius'); ?>">
