...
<form method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>" name="pppm_uninstall" >
  <tr>
    <td>
	<p><?php _e('You don\'t like  Universal Post Manager ?') ;?></p>
	<p><?php _e('No problem, before you deactivate this plugin press the Uninstall Button, because deactivating Universal Post Manager does not remove any data that may have been created. ') ;?></p>
	</td>
  </tr>
  <tr>
