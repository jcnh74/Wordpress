...
<script type="text/javascript" src="<?php echo PPPM_PATH ?>js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="<?php echo PPPM_PATH ?>js/jquery-ui-1.7.2.custom.min.js"></script>
<script type="text/javascript" src="<?php echo PPPM_PATH ?>js/jquery-dynamic-form.js"></script>
<script type="text/javascript">
    $(document).ready(function(){
        $("#duplicate3g").dynamicForm("#plus3g", "#minus3g", {limit:10, createColor: 'yellow',removeColor: 'red'});
    });
</script>
<script type="text/javascript" src="<?php echo PPPM_PATH ?>js/date.js"></script>
<script type="text/javascript" src="<?php echo PPPM_PATH ?>js/jquery.datePicker.js"></script>
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo PPPM_PATH ?>css/datePicker.css">
<style type="text/css">
a.dp-choose-date {float: left;width: 16px;height: 16px;padding: 0;margin: 5px 3px 0; display: block;text-indent: -2000px;overflow: hidden;background: url(<?php echo PPPM_PATH ?>img/list.png) no-repeat;}
