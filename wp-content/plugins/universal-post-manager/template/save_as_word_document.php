...
<head>
<meta http-equiv=Content-Type content="application/msword; charset='.get_option('blog_charset').'">
...
<div class=Section1 style="text-align:'.get_option('pppm_save_text_align').'">
