...
function ebor_cpt_add_options_page() {
	$theme = wp_get_theme();
	add_dashboard_page( $theme->get( 'Name' ) . ' Post Type Options', $theme->get( 'Name' ) . ' Post Type Options', 'manage_options', __FILE__, 'ebor_cpt_render_form');
}
...
?>
	...
	<div class="wrap">
		...
		<h2><?php echo $theme->get( 'Name' ); _e(' Custom Post Type Settings','ebor'); ?></h2>
